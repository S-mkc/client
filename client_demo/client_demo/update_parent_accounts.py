...
def update_parent_accounts():
    ...
    accounts_to_update = [
        ...
        {"account_name": "19000N PettyCash/NPR Kathmandu (N) - HPL", "new_parent_account": "51000 - Direct Expenses - HPL"},
        {"account_name": "19201N SCB/NPR 01-0417289-01 CUR  (N) - HPL", "new_parent_account": "51000 - Direct Expenses - HPL"},
        {"account_name": "19201N SCB/NPR 01-0417289-01 CUR  (N)(GBP) - HPL", "new_parent_account": "51000 - Direct Expenses - HPL"},
        {"account_name": "19201N SCB/NPR 01-0417289-01 CUR (N) - HPL", "new_parent_account": "51000 - Direct Expenses - HPL"},
        {"account_name": "19212N NMB/NPR0200010920300012 CUR  (N) - HPL", "new_parent_account": "51000 - Direct Expenses - HPL"},
