...
app_title = "For Client Demo"
app_publisher = "Raidnrop"
app_description = "This app is created to customize requirement as per client for demo"
...
app_include_js = "/assets/client_demo/js/custom_child_table.js"
